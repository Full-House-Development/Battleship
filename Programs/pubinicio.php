			...
			<li>
			  <div onclick='collapsible()' class='collapsible-header'><i class='material-icons'>textsms</i>Comentarios</div>";
				$pub=$fila['id_publicaciones'];
					if($pub>0)
					{
						$quecom="SELECT comentario.texto_comentario,comentario.tiempo_comentario FROM comentario JOIN publicaciones ON publicaciones.id_publicaciones=comentario.id_publicacion WHERE comentario.id_publicacion='".$pub."'"; 
					}
			  ...
			  <form method='POST' action='adentro2.php'>
				<div class='row'>
				  <div class='input-field col s6'>
					<input id='input_text' name='com".$fila['id_publicaciones']."' type='text' data-length='30'>
