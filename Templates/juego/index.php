...
<html>
  ...
  <!--Links de materialize y el css/less-->
    ...
    <link rel="stylesheet" type="text/css" href="../../Documents/lib/sweetswal.css">
  ...
  <!--Scripts que se necesitaran-->
    ...
    <script src="../../Documents/lib/sweetswal.min.js"></script>
  </head>
  <body>
      <!--Encabezado-->
      <nav>
              ...
              for (var beta = 0; beta < 10; beta++) {
                  ...
                  $('#m'+alfa+beta).on('click', function(e){
                    ...
                    if(barcos<5){
                      ...
                      swal("ya acomodaste tus basrcos");
                    }
                  });
                  columna =$('<td></td>');
                  columna.append($('<img srcset="../../Resources/Images/normal.svg"/>'));
