...
//---sacar todas las publicaciones---
	...
	if($usu!="")
	{
		$que="SELECT usuario.id_usuario,usuario.nombre_usuario,publicaciones.texto_publicacion,publicaciones.id_publicaciones,publicaciones.tiempo_publicacion FROM publicaciones JOIN usuario ON usuario.id_usuario=publicaciones.id_usuario WHERE usuario.id_usuario!='".$usuario."' ORDER BY publicaciones.tiempo_publicacion DESC";
